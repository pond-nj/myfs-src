...
//     fd = log_syscall("client_open", client_open(path, fi->flags), 0);
//     if (fd < 0)
...
//     {
//         // if(strcmp(BB_DATA->metadata.files[i].name, ".") == 0 || strcmp(BB_DATA->metadata.files[i].name, "..") == 0)
//         //     continue;
